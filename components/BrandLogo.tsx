    ...
    return (
      <View 
        style={{
          ...
          borderWidth: 1,
          borderColor: 'rgba(255, 255, 255, 0.15)', // Extremely thin, soft border
          shadowColor: '#000',
      ...
      >
        ...
        {/* Apple-style Top Edge Glare Line */}
        <LinearGradient
        ...
        {/* Bottom Ambient Glow / Shadow Overlay */}
        <LinearGradient
  ...
  return (
    <LinearGradient
      ...
      style={{
        ...
        padding: padding,
        borderWidth: 1,
        borderColor: 'rgba(255, 255, 255, 0.15)', // Extremely thin, soft glass border
        shadowColor: '#000',
        shadowOffset: { width: 0, height: 2 },
        shadowOpacity: 0.06,
        shadowRadius: 3.5,
    ...
    >
      ...
      {/* Bottom Ambient Glow / Shadow Overlay */}
      <LinearGradient
        colors={['rgba(0, 0, 0, 0.04)', 'rgba(0, 0, 0, 0.0)']}
        start={{ x: 0.5, y: 1 }}
        end={{ x: 0.5, y: 0 }}
        style={{
          position: 'absolute',
